      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="view-options">
          <div class="btn-group" role="group">
            ...
            <label class="btn btn-outline-primary btn-sm" for="grid-view">🔳 Grid</label>
            
            <input type="radio" class="btn-check" name="viewType" id="list-view" autocomplete="off" v-model="viewType" value="list">
            <label class="btn btn-outline-primary btn-sm" for="list-view">📋 List</label>
          </div>
        </div>
      </div>
    </div>
